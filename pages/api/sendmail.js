...
export default (req, res) => {
  const { email, firstName, lastName, message, phone } = req.body.values;
  ...
  const mailOptions = {
    ...
    subject: `${firstName} ${lastName} Has Submitted a Contact Form!`,
    html: `
...
>
  <head>
    ...
    <link
      ...
      sizes="76x76"
      href="http://paulgoddarddesign.com/images/apple-icon.jpg"
    />
    <link
      rel="icon"
      type="image/png"
                            ...
                            >
                              ...
                              <tr>
                                ...
                                >
                                  <img
                                    ...
                                    "
                                    class="hund"
                                    src="http://paulgoddarddesign.com/emails/images/material-design/material-header-2.jpg"
                                  />
                                </td>
                              </tr>
                              <!-- END HEADER IMAGE -->
                              ...
                              <tr>
                               ...
                               <tr>
                                <td
                                  ...
                                  "
                                >
                                  <span style="font-weight: bold">Phone Number</span> ${phone}
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td
                                  ...
                                  "
                                >
                                <div style="font-weight: bold"; padding-bottom: 15px !important>Message:</div>
                                <div>
                                ${message}
                                </div>
